...
async fn meme_meme_pair_test() {
    ...
    let mut meme_chain_0 = suite.meme_chain_0.clone();
    let mut meme_chain_1 = suite.meme_chain_1.clone();
    ...
    // The placeholder chains above are replaced by the proxy-created meme chains.
