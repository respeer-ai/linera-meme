...
export type ListQueryVariables = Exact<{
  createdBefore?: InputMaybe<Scalars['Timestamp']['input']>;
  createdAfter: Scalars['Timestamp']['input'];
  dataType?: InputMaybe<BlobDataType>;
  limit: Scalars['Int']['input'];
}>;
