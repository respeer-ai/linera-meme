...
class PositionMetricsPartialResultBuilderTest(unittest.TestCase):
    def test_build_initializes_partial_metrics_shape(self):
        ...
        self.assertEqual(result['position_liquidity'], '1.23')
        self.assertEqual(result['current_total_supply'], '5.0')
        ...
        self.assertFalse(result['fee_calculation_complete'])
        self.assertFalse(result['principal_calculation_complete'])
