...
class DecodeResultNormalizerTest(unittest.TestCase):
    ...
    def test_normalize_item_covers_remaining_pool_family_mappings(self):
        cases = [
            ...
            ('message', 'initialize_liquidity', 'pool_initialize_liquidity_message_observed', 'observed', False),
            ...
            ('message', 'initialize_liquidity', 'pool_initialize_liquidity_message_rejected', 'rejected', True),
