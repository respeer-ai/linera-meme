...
class BlockParserTest(unittest.TestCase):
    ...
    def test_parse_normalizes_confirmed_block_graphql_shape(self):
        ...
        self.assertIsNone(block['incoming_bundles'][0]['posted_messages'][0]['origin_chain_id'])
        self.assertIsNone(block['incoming_bundles'][0]['posted_messages'][0]['source_cert_hash'])
        self.assertEqual(block['incoming_bundles'][0]['posted_messages'][0]['transaction_index'], 2)
