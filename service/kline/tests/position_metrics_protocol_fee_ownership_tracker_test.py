...
class PositionMetricsProtocolFeeOwnershipTrackerTest(unittest.TestCase):
    ...
    def test_summarize_keeps_full_owner_protocol_fee_liquidity_before_remove_basis(self):
        ...
        self.assertEqual(result['basis_protocol_fee_liquidity_owned_by_current_owner'], '3')
        self.assertEqual(result['protocol_fee_liquidity_owned_by_current_owner_current'], '3')
        self.assertEqual(result['full_protocol_fee_liquidity_owned_by_current_owner'], '15')
        self.assertEqual(result['full_protocol_fee_liquidity_owned_by_other_accounts'], '0')
        self.assertEqual(result['full_protocol_fee_liquidity_owner_unknown'], '0')
        self.assertEqual(result['full_protocol_fee_current_owner_provenance_case'], 'all_mints_owned_by_current_owner')
