...
class FakeDb:
    ...
    def get_last_kline(self, token_0, token_1, interval):
        ...
        return (
            ...
            2_000,
            interval,
            [{'timestamp': 1_000, 'open': 1.0, 'high': 1.0, 'low': 1.0, 'close': 1.0, 'volume': 1.0}],
        )
        ...
        await self.manager.notify_kline({
            '5min': [
                ...
                },
                {
                    ...
                    'start_at': 1_000,
                    'end_at': 2_000,
                    'points': [{'timestamp': 1_000, 'open': 2.0, 'high': 2.0, 'low': 2.0, 'close': 2.0, 'volume': 2.0}],
                },
            ],
            '1min': [
                {
                    ...
                    'start_at': 1_000,
                    'end_at': 2_000,
                    'points': [{'timestamp': 1_000, 'open': 3.0, 'high': 3.0, 'low': 3.0, 'close': 3.0, 'volume': 3.0}],
                },
            ],
        })
