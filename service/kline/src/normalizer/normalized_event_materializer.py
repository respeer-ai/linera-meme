class NormalizedEventMaterializer:
    def __init__(
        ...
        pool_fee_to_history_projection_materializer=None,
    ):
        ...
        self.pool_fee_to_history_projection_materializer = pool_fee_to_history_projection_materializer
    ...
    def materialize_item(self, item: dict) -> dict[str, object]:
        ...
        self._materialize_pool_fee_to_history(normalized['normalized_events'])
        return normalized
    ...
    def materialize_batch(self, items: list[dict]) -> list[dict[str, object]]:
        ...
        self._materialize_pool_fee_to_history(events)
    ...
    def _materialize_pool_fee_to_history(self, events: list[dict[str, object]]) -> None:
        if self.pool_fee_to_history_projection_materializer is None:
            return
        self.pool_fee_to_history_projection_materializer.materialize_events(events)
