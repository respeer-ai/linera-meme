class NormalizedEventResult:
    ...
    FAMILY_POOL_FUND_SUCCESS_RECORDED = 'pool_fund_success_recorded'
    FAMILY_POOL_FUND_FAIL_RECORDED = 'pool_fund_fail_recorded'
    FAMILY_POOL_TRANSACTION_RECORDED = 'pool_transaction_recorded'
