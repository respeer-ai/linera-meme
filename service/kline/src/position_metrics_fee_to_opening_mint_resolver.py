...
class PositionMetricsFeeToOpeningMintResolver:
    ...
    def resolve(
        ...
        *,
        ...
        liquidity_basis = precheck_context['current_liquidity']
        protocol_fee_amount0 = Decimal('0')
        protocol_fee_amount1 = Decimal('0')
        if (
            precheck_context['current_liquidity'] is not None
            and precheck_context['current_liquidity'] - precheck_context['history_liquidity'] > self.epsilon
        ):
            ...
            protocol_fee_amount0_attos, protocol_fee_amount1_attos = self.split_protocol_fee_redeemable_attos(
                ...
                current_liquidity=precheck_context['current_liquidity'],
