<template>
  <q-btn-dropdown
    ...
    class="chart-toolbar-select chart-toolbar-select--indicators radius-8"
  >
    <q-list dense class="bg-dark-secondary text-neutral" style="min-width: 200px">
      ...
      <q-item v-for="ma in maIndicators" :key="ma.key" clickable @click="toggleMA(ma.key)">
        <q-item-section side>
          <q-toggle
      ...
      <q-item v-for="ema in emaIndicators" :key="ema.key" clickable @click="toggleEMA(ema.key)">
        <q-item-section side>
          <q-toggle
      ...
      <q-item clickable @click="toggleVolume">
        ...
        <q-item-section>
          <q-item-label>Volume (VOL)</q-item-label>
        </q-item-section>
      </q-item>
    </q-list>
  </q-btn-dropdown>
...
.chart-toolbar-select--indicators
  width: auto
</style>
