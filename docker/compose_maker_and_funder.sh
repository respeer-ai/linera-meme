...
function run_kline() {
    ...
    NO_PROXY="$NO_PROXY_VALUE" no_proxy="$NO_PROXY_VALUE" \
      ...
      SWAP_HOST=$SWAP_HOST PROXY_HOST=$PROXY_HOST DATABASE_HOST=$DATABASE_HOST DATABASE_USER=$DATABASE_USER DATABASE_PASSWORD=$DATABASE_PASSWORD DATABASE_PORT=$DATABASE_PORT DATABASE_NAME=$DATABASE_NAME \
      SUB_DOMAIN=$CLUSTER. \
