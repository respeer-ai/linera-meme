...
- User-facing conversation in this repository may use Chinese, but repository documents, assistant primitives, AI constraints, skills, task titles, and task notes must be written in English
