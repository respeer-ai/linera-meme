...
- This skill covers the whole kline service package
- Observability migration is one workstream inside this skill
...
- `agents/skills/observability-migration/SKILL.md`
