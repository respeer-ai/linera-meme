...
- This file decomposes `agents/skills/kline-phase1-plan/SKILL.md` into concrete work packages
...
- `agents/skills/kline-phase1-plan/SKILL.md`
...
- `agents/skills/kline-phase1-rollout/SKILL.md`
